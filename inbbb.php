...
.full-width-image {
    width: 100%;
    min-height: 400px; /* Adjusted to fit the image's aspect ratio */
    position: relative;
    z-index: 1;
    background-image: url('image.jpg'); /* Correct path for same directory */
    background-size: contain; /* Show the entire image without cropping */
    background-position: center; /* Center the image */
    background-repeat: no-repeat; /* Prevent tiling */
    background-color: #f5e8c7; /* Beige background to match the image for letterboxing */
    display: flex;
    align-items: center;
    justify-content: center;
    text-align: center;
...
/* Remove the .full-width-image img styles since we're using a background image */
